**NOTE:** 
- WhiteGrabber was made for educational purposes, there for all consequences caused by your actions are **your** responsibility and accountability.
...
```d
@WhiteGrabber: Here put your Discord Webhook you can find it in your 
...
```d
@WhiteGrabber: Here put your final file name like who is not going to be obvious
```
![](https://media.discordapp.net/attachments/912038729626058853/1062468541967773756/image.png)
```d
@WhiteGrabber: This is a option to "KILL" all discord clients opened 
and to restart them with the WhiteGrabber injection 
(so i recommand "yes")
```
![](https://media.discordapp.net/attachments/912038729626058853/1062469117954768998/image.png)
```d
@WhiteGrabber: This is a option to "KILL" all process which could analyze the properties of WhiteGrabber, 
...
```d
@WhiteGrabber: This is a option to ping when someone run WhiteGrabber you can specify "everyone" or "here"
```
![](https://media.discordapp.net/attachments/912038729626058853/1062470764609151016/image.png)
```d
@WhiteGrabber: This option replaces each of the crypto addresses copied by the victim with yours, 
...
```d
@WhiteGrabber: If you chose 'yes' to the previous option you will have to fill in this with 
...
```d
@WhiteGrabber: This option allows you to display an error message when someone launches your WhiteGrabber 
...
```d
@WhiteGrabber: This option will make a copy of the .exe in the windows startup of your victims and 
WhiteGrabber will therefore launch at each start
...
```d
@WhiteGrabber: This option will close automatically the window that will launch WhiteGrabber 
...
```d
@WhiteGrabber: This option will obfuscate the source code "BUT THIS OBFUSCATION WAS DETECTED"
I recommand to chose 'no'
```
![](https://media.discordapp.net/attachments/912038729626058853/1062474365079388201/image.png)
```d
@WhiteGrabber: This option will create an .exe if you put 'no' the final file will be an .py
```
![](https://media.discordapp.net/attachments/912038729626058853/1062474813135925288/image.png)
```d
@WhiteGrabber: If you chose 'yes' in the previous option this option will add an icon to your .exe
```
